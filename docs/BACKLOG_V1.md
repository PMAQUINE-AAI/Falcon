...
| 7b | `[ ]` | Brouillon de pipeline depuis une trace (§4.3) | 6, 8 | une trace produit un YAML chargeable par le lot 8 **en brouillon** ; les gestes non rejouables sont marqués comme tels |
