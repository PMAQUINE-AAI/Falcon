> **Archive.** Ce document décrit Phenix, l'état du projet avant la
> spécification FALCON. Il est conservé pour mémoire et n'est plus la
> référence : voir [SPEC_FALCON.md](../SPEC_FALCON.md) à la racine, et le
> tableau de statut du [README racine](../README.md) pour savoir ce qui reste
> vivant ici.
